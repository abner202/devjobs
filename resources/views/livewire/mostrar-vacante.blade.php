<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-50 p-4 my-10 ">
            ...
            <p class="font-bold text-sm uppercase text-gray-800 my-3">Último día para postularse:
                <span class="normal-case font-normal">{{ \Carbon\Carbon::parse($vacante->ultimo_dia)->isoFormat('LL', 'es')}}</span>
            </p>
    ...
    @guest
        <div class="mt-5 bg-gray-50 border boder-dashed p-5 text-center">
            <p>
                ¿Deseas aplicar o esta vacante? <a class="font-bold text-indigo-600" href="{{route("register")}}">Obten una cuenta y aplica a esta y otras vacantes</a>
            </p>
        </div>
    @endguest
